...
/*----------------------------------------------------------*/	
	...
	$miSQL = "SELECT * FROM tciudadpais WHERE idCiudad=$idCiudad AND idPais=$idPais";
	...
	$urlMetaTags="editor.MetaTags.php?tabla=tciudadpais&criterio=idCiudad=$idCiudad AND idPais=$idPais";
	
/*
	Preparación de la plantilla respectiva
	--------------------------------------
*/	
	$t = new TemplatePower("./editor.CiudadPais_tp.htm");
	$t->prepare();		
