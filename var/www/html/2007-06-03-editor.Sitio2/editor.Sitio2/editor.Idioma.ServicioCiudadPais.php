...
/*----------------------------------------------------------*/	
	...
	$miSQL = "SELECT * FROM nptidiomapaisserviciociudad 
						WHERE idIdioma=$idIdioma AND idServicio=$idServicio AND idCiudad=$idCiudad AND idPais=$idPais";
	...
	$urlMetaTags="editor.MetaTags.php?tabla=nptidiomapaisserviciociudad&criterio=idIdioma=$idIdioma AND idServicio=$idServicio AND idCiudad=$idCiudad AND idPais=$idPais";
	
/*
	Preparación de la plantilla respectiva
	--------------------------------------
*/	
	$t = new TemplatePower("./editor.Idioma.ServicioCiudadPais_tp.htm");
	$t->prepare();		
