...
// Ver si hay metatag definido
	$miSQL="SELECT idMetas 
					...
					WHERE idIdioma=$txtIdIdioma AND idServicio=$txtIdServicio AND idPais=$txtIdPais";
	...
	$miSQL="DELETE FROM nptidiomapaisservicio WHERE idIdioma=$txtIdIdioma AND idServicio=$txtIdServicio AND idPais=$txtIdPais";
	$result = mysql_query($miSQL);
	
	$miSQL="INSERT INTO nptidiomapaisservicio 
					(	idIdioma,
						idServicio,
						idPais,
						nombreLocal,
	...
	//editor.Idioma.Pais.php?idIdioma=1&idPais=1
