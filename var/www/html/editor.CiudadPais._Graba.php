...
// Ver si hay metatag definido
	$miSQL="SELECT idMetas 
					FROM tciudadpais 
					WHERE idCiudad=".$txtIdCiudad." AND idPais =".$txtIdPais;
	...
	$miSQL="DELETE FROM tciudadpais WHERE idCiudad=".$txtIdCiudad." AND idPais =".$txtIdPais;
	$result = mysql_query($miSQL);
	
	$miSQL="INSERT INTO tciudadpais 
					(	idCiudad,
						idPais,
						nombreLocal,
						descripcion,
