...
include ($_SERVER['DOCUMENT_ROOT']."/class.Upload/upload_class.php"); 

$max_size = 250*1024; // the max. size for uploading
	
$my_upload = new file_upload;
	$my_upload->upload_dir = $_SERVER['DOCUMENT_ROOT']."/quality-courses/Image/"; 
	$my_upload->extensions = array(".jpg", ".gif", ".png"); 
	//$my_upload->extensions = "es"; 
	$my_upload->max_length_filename = 75; 
...
<body>
<h3>Carga simple de imágenes:</h3>
<p>Tamaño Max. = <?php echo $max_size/1024; ?> Kb.</p>
