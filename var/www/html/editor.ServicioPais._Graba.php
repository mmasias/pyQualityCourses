...
// Ver si hay metatag definido
	$miSQL="SELECT idMetas 
					FROM tserviciopais 
					WHERE idServicio=$txtIdServicio AND idPais=$txtIdPais";
	...
	$miSQL="DELETE FROM tserviciopais WHERE idServicio=".$txtIdServicio." AND idPais =".$txtIdPais;
	$result = mysql_query($miSQL);
	
	$miSQL="INSERT INTO tserviciopais 
					(	idServicio,
						idPais,
						nombreLocal,
						descripcion,
